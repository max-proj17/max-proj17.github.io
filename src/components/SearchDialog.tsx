...
const searchData = [
	...
	},
	{
		...
		path: '/skills',
		keywords: ['skills', 'technologies', 'programming', 'languages', 'frameworks', 'web', 'development', 'software', 'tools']
	},
	{
		title: 'Projects',
...
const SearchDialog = () => {
	...
	useEffect(() => {
		const handleKeyDown = (e: KeyboardEvent) => {
			// Toggle search dialog with Cmd/Ctrl + K
	...
	if (!isOpen) {
		return (
			<button
				...
				className="flex items-center space-x-2 px-3 py-1.5 text-gray-400 hover:text-white transition-colors bg-white/15 rounded-lg hover:bg-white/10 cursor-text"
			>
