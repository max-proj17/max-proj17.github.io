...
import {
  ...
  CSSLogo, ReactLogo, NodeLogo, MySQLLogo,
...
const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'ShadCN', icon: <Code2 className="w-4 h-4" /> }
    ]
  },
  {
    category: 'Back-End Development & Frameworks',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Vercel', icon: <Code2 className="w-4 h-4" /> },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'MySQL', icon: <MySQLLogo /> },
      { name: 'MongoDB', icon: <MongoDBLogo /> },
      { name: 'VirtualBox', icon: <Terminal className="w-4 h-4" /> }
    ]
  }
];
